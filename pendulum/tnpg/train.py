...
def train_model(actor, critic, critic_optimizer, trajectories):
    ...
    actor_loss = get_loss(actor, values, targets, log_policy)
...
def main():
    ...
    for iter in range(args.max_iter_num):
        ...
        actor.train()
        train_model(actor, critic, critic_optimizer, trajectories)
