...
parser.add_argument('--discrim_update_num', type=int, default=8, 
                    help='update number of discriminator (default: 4)')
...
if args.load_demo_size == 5000:
    load_demo = './expert_demo/expert_demo_5031.npy'
elif args.load_demo_size == 20000:
    load_demo = './expert_demo/expert_demo_20011.npy'
elif args.load_demo_size == 35000:
    load_demo = './expert_demo/expert_demo_35011.npy'
elif args.load_demo_size == 50000:
    load_demo = './expert_demo/expert_demo_50116.npy'
...
def main():
    ...
    discrim = Discriminator(num_inputs + action_dim, args)
    ...
    for iter in range(args.max_iter_num):
        ...
        while steps < args.total_sample_size: 
            ...
            for _ in range(200): 
                ...
                policies = actor(torch.Tensor(state).unsqueeze(0))
